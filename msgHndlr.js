...
module.exports = msgHandler = async (client, message) => {
    try {
        ...
        const ownerNumber = ["6289677763976@c.us","6289677763976"] // replace with your whatsapp number
        ...
        case '!donasi':
        case '!donate':
            client.sendLinkWithAutoPreview(from, 'https://saweria.co/donate/rey404', donate)
            break
        case '!tts':
        ...
        case '!fb':
            ...
            break
        case '!creator':
            client.sendContact(from, '6289677763976@c.us')
            break
        case '!ig':
